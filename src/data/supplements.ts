...
export const supplements: Supplement[] = [
  ...
  },
  {
    ...
    cautions: ['May cause GI upset at high doses', 'Can thin blood', 'Outdated claims that piperine boosts absorption by 2000% are not supported by recent data', 'Simple curcumin + piperine products often underperform modern delivery systems'],
  ...
  // ============ VITAMINS ============
  {
    ...
    cautions: ['Avoid routine high-dose supplementation or routine testing without clear risk or deficiency (2024 guidance)', 'Can cause toxicity if overdone'],
  ...
  },
  {
    ...
    cautions: ['CRITICAL: Interferes with 30+ lab tests including troponin, thyroid panels, tumor markers, and hormone assays; can cause false results', 'FDA has warned of false-negative troponin results in biotin users'],
  ...
  },
  {
    ...
    cautions: ['Higher doses (3-10mg) do not improve sleep outcomes but increase next-day grogginess and temperature changes', 'May cause vivid dreams'],
  ...
  },
  {
    ...
    evidence: 'moderate',
    foodSources: ['Not available in food'],
    cautions: ['Does NOT reliably increase testosterone in men with normal levels', 'Erectile/infertility benefits are modest or inconsistent in trials'],
