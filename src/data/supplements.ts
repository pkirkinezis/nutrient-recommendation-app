...
export const supplements: Supplement[] = [
  ...
  },
  {
    ...
    synergies: ['Black pepper (piperine)', 'Ginger', 'Boswellia', 'Omega-3'],
  ...
  // ============ VITAMINS ============
  {
    ...
    cycleTiming: 'Used continuously, especially in winter or for those with limited sun exposure.',
  ...
  },
  {
    ...
    type: 'vitamin',
    category: 'modern',
    description: 'The most searched supplement for hair, skin, and nails. Essential for keratin production.',
    ...
    cautions: ['CRITICAL: Interferes with thyroid and heart attack lab tests (false positives/negatives)'],
    drugInteractions: ['Anticonvulsants'],
    avoidIf: ['Stop 3-5 days before ANY blood work'],
    cycleTiming: 'Can be used continuously.',
  ...
  },
  {
    ...
    type: 'other',
    category: 'modern',
    description: 'Universal antioxidant soluble in water and fat. Regenerates other antioxidants. Supports blood sugar and nerve health.',
  ...
  },
  {
    ...
    type: 'ayurvedic',
    category: 'both',
    description: 'Ayurvedic herb for urinary and reproductive health. Despite marketing, does NOT reliably boost testosterone.',
    ...
    evidence: 'moderate',
    foodSources: ['Not available in food'],
    cautions: ['Does NOT reliably increase testosterone despite marketing claims'],
...
export const formGuidance: Record<string, {
  ...
  'turmeric-curcumin': {
    forms: [
      { name: 'Phytosome (Meriva)', bioavailability: '29x better', bestFor: 'Well-absorbed, joint support.' },
      { name: 'Theracurmin', bioavailability: '27x better', bestFor: 'Micro-particle, excellent absorption.' },
      { name: 'BCM-95', bioavailability: '7x better', bestFor: 'Contains essential oils, cost-effective.' },
      { name: 'Curcumin + Piperine', bioavailability: '20x better', bestFor: 'Common, effective, affordable.' },
      { name: 'Standard 95% alone', bioavailability: 'Poor', bestFor: 'Avoid unless with piperine.', avoid: true },
    ],
    enhancers: ['Piperine/Black pepper (20x)', 'Fat', 'Heat'],
    blockers: ['Taking alone without enhancers'],
    timing: 'With meals containing fat and black pepper.',
...
export const supplementComparisons: Array<{
  ...
  },
  {
    ...
    optionB: {
      ...
      cons: ['Poor absorption alone', 'Needs piperine or special form'],
      evidence: 'Strong'
    },
...
export const misinformationAlerts: Record<string, { claim: string; reality: string; recommendation: string }> = {
  ...
  'biotin-labs': {
    ...
    reality: 'While generally safe, Biotin interferes with Troponin (heart attack) and TSH (thyroid) blood tests, leading to false results.',
    recommendation: 'Stop taking Biotin 3-5 days before ANY blood draw or medical test. Tell your doctor you take it.'
  }
};
