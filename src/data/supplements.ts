...
export const supplements: Supplement[] = [
  ...
  },
  {
    ...
    cautions: ['May cause GI upset', 'Goitrogenic (affects thyroid in sensitive individuals)', 'Consider stopping once pregnant due to limited pregnancy data'],
