...
export const supplementComparisons: Array<{
  ...
  },
  {
    ...
    optionA: {
      name: 'L-Arginine',
      pros: ['Direct nitric oxide precursor', 'Affordable', 'Some ED trial support at higher doses'],
      cons: ['Lower bioavailability (liver breakdown)', 'More GI upset at higher doses', 'Shorter duration'],
      evidence: 'Moderate'
    },
    optionB: {
      name: 'L-Citrulline',
    ...
    verdict: 'Citrulline is generally more efficient for raising arginine levels, while arginine still has clinical ED data at higher doses. Choose based on goal and tolerance.',
    canCombine: true
  },
  {
